...
const $cfe897238575280a$export$bfd39fdfb84f21cc = (payload)=>{
    ...
    else if (payload.method == "eth_coinbase" && typeof window.wootzappAppcurrentAccountAddress !== "undefined") return $cfe897238575280a$export$6ffaaff3791e4fb3(payload, window.wootzappAppcurrentAccountAddress);
    else if (payload.method == "net_version" || payload.method == "eth_chainId") return $cfe897238575280a$export$6ffaaff3791e4fb3(payload, window.wootzappAppNetworkId);
...
//# sourceMappingURL=wootzapp-min.js.map
